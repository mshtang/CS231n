...
# def f1(w): return svm_loss_naive(w, X_dev, y_dev, 5e1)[0]


# grad_numerical = grad_check_sparse(f, W, grad)
# grad_check_sparse(f1, W, grad)
...
regularization_strengths = [2.5e4, 5e4, 1e4, 1e5]

# results is dictionary mapping tuples of the form
# (learning_rate, regularization_strength) to tuples of the form
# (tr_acc, validation_accuracy). The accuracy is simply the fraction
